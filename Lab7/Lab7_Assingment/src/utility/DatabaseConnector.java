...
public static void addPatient(Patient p1) throws SQLException {
    ...
    String query = "INSERT INTO patient(firstname, lastname, gender, age, patient_type) VALUES(?,?,?,?,?) ;";
    try { 
        // Create a connection
        Connection conn = DriverManager.getConnection(DB_URL, DB_USERNAME, DB_PASSWORD);
        PreparedStatement stmt = conn.prepareStatement(query);
        
        // Correctly set parameters in the same order as in the query
        stmt.setString(1, p1.getName());
        stmt.setString(2, p1.getLname());
        stmt.setString(3, p1.getGender());   // gender as third parameter
        stmt.setInt(4, p1.getAge());         // age as fourth parameter
    ...
    public static void updatePatient(Patient oldPatient, Patient newPatient) {
        ...
        try {
            ...
            stmt.setString(5, newPatient.getPaitientType());
            stmt.setInt(6, oldPatient.getId());
            int rows = stmt.executeUpdate();
